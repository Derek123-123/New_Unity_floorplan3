...
public class EditButton2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // define save path
        interactableDD = true;
        savePath = Path.Combine("../../item_json", "cubes.json"); //define the save path
                ...
                else if (timeSinceMouseDown >= clickTimeThreshold && touch_count == 1)
                {
                    ...
                    if (hits != null && hits.Length > 0)
                    {
                        ...
                        foreach (var h in hits)
                        {
                            ...
                            bool isFloor = (floorLayer != -1 && go.layer == floorLayer)|| go.name == "Floor"; ;
